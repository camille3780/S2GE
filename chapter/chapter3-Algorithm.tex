...
The following section will describe how to properly set up the environment we used to conduct our experiment. First, we used Anaconda as our package management tool for the implementation. Therefore, you must first visit the Anaconda official website (https://www.anaconda.com/download) to download the software. As shown in figure \ref{fig: conda}, click the Download button to complete the download.
